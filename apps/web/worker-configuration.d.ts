/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7dcb359a3add9648886d4bbf229839a0)
// Runtime types generated with workerd@1.20260630.1 2026-07-01 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	FOLIO_APP_NAME: "Folio";
	GITHUB_CLIENT_ID: string;
	GITHUB_CLIENT_SECRET: string;
	GITHUB_APP_ID: string;
	GITHUB_APP_PRIVATE_KEY: string;
	REPO_DO: DurableObjectNamespace<import("./src/server").RepoObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "RepoObject";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FOLIO_APP_NAME" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GITHUB_APP_ID" | "GITHUB_APP_PRIVATE_KEY">> {}
}
