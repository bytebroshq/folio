...
export const Route = createFileRoute("/_authenticated/setup/repos")({
	...
	pendingComponent: () => <p className="text-zinc-400">Loading...</p>,
		...
		return (
			<div>
				...
				<p className="text-zinc-500 text-sm">
					...
					<a href="/login/github" className="text-blue-400 hover:underline">
						re-login
					</a>{" "}
		...
		<div>
			...
			<ul className="space-y-2">
				{installations.map((inst) => (
					<li key={inst.id} className="border border-zinc-800 rounded-lg p-3">
