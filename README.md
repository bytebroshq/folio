...
- **Folio skill** — portable agent guidance for reading, writing, linting, and reviewing folios. See [`.agents/skills/folio`](.agents/skills/folio).
...
- [`.agents/skills/folio`](.agents/skills/folio) — portable Folio agent skill
