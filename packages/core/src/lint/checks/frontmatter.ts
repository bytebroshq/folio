...
/**
 * Extract a single top-level frontmatter field's raw value as plain text.
 * This is intentionally not a YAML parser — it matches a `field: value` line
 * in the frontmatter block and strips one layer of surrounding quotes.
 * Returns undefined when the file has no frontmatter or the field is absent.
 */
